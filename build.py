...
SCRIPTS = '''  <script src="/js/nav.js?v=1"></script>
  ...
  <script type="text/javascript" src="https://directng.tranzila.com/Tranzila_files/jquery.js"></script>
  <script>document.write('<script src="https://directng.tranzila.com/js/tranzilanapple_v3.js?v=' + Date.now() + '"><\\/script>');</script>
